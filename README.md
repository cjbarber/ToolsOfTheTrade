...
* Jenkins | http://jenkins-ci.org | [@jenkinsci](https://twitter.com/jenkinsci) | Jenkins monitors and manages the execution of repeated jobs, such as building a software project or jobs run by cron. It focuses on building and testing software projects and provides an open source, MIT licensed, easy-to-use continuous integration system.
