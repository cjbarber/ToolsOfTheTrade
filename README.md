...
#### Bug/Issue Tracking
* TrackDuck | http://trackduck.com | [@trackduck](https://twitter.com/TrackDuck) | $19/mo - $49/mo | Provides Visual Feedback for Websites and Web Development while streamlining the communication process throughout projects | Provides Visual Feedback for Websites and Web Development and streamlines the communication process. With one click clients provide feedback for any part of a web page TrackDuck helps you understand your clients faster, better and create more value for them.
