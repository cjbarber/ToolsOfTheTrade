...
* Redmine | http://www.redmine.org | [@redmineapp](https://twitter.com/redmineapp) | Flexible project management web application. Written using Ruby on Rails framework, it is cross-platform and cross-database.
...
to send email from web apps | ostageApp helps design, send, and analyze emails within minutes.
