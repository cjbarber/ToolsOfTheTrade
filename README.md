...
| [Pin](https://pinpayments.com) | [@pin_payments](https://twitter.com/pin_payments) | 2.9% + 30¢/successful charge. | Payments, Rebooted. Accepting credit card payments from a global audience typically requires a merchant acount. The process of establishing a merchant account for each currency can be too difficult and costly for small businesses. |
