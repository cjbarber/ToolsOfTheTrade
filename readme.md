...
| [Arch Tools](https://archtools.dev) | - | Free - Pay-per-use | 61 production-ready AI API tools for code analysis, web scraping, image generation, NLP, crypto, and search. REST API and MCP protocol with x402 micropayments. Free 100 credits/month. |
