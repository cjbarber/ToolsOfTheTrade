...
| [GrowthBook](https://www.growthbook.io) | [@growth_book](https://twitter.com/growth_book) | free - $20/user/mo | Open-source feature flagging and experimentation platform that helps you release code better and measure the impact with your own data. GrowthBook is an in-house A/B testing platform you don't have to build. Available in cloud or self-hosted. |
