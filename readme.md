...
| [ToolPipe](https://troops-submission-what-stays.trycloudflare.com) | - | Free | 220+ free developer utility APIs in one REST endpoint. JSON formatting, QR codes, hashing, UUID, DNS, WHOIS, scraping, PDF generation, SEO tools, fake data, and more. No API key required for the free tier. |
