...
| [BitDive](https://bitdive.io) | - | Free tier available | APM for Java/Kotlin with distributed tracing, runtime profiling, service maps, and zero-code integration testing. Captures real application behavior and generates tests automatically. |
