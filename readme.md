...
| Service | Twitter | Pricing | Description |
|:--------|:--------|:--------|:------------|
| [Notifier.so](https://notifier.so/?ref=https%3A%2F%2Fgithub.com%2Fcjbarber%2FToolsOfTheTrade) | [@notfier_so](https://twitter.com/notfier_so) | $14/mo - $99/mo | Get Notified when keywords you care about (and soon other events) occur on the the internet. We support string and regex based matching. The platforms we support are Reddit, Hacker News, and Lobsters. Twitter and many others are in development. We are also working on website monitoring and more. You can get Notified via email, webhook, Slack and more! |
