...
| [Count](https://count.co) | [@count](https://twitter.com/counthq) | $0/mo - $20/mo | Count is a notebook-based anlytics and visualisation platform using SQL or drag-and-drop. Count connects to your data warehouse to run queries. It also (optionally) intelligently caches results to minimise the load on your databases. |
